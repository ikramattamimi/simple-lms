            ...
            <div class="card">
                <div class="card-body text-center">
                    @if ($course->students->contains(auth()->user()))
                        <a class="btn btn-primary col-12" href="{{ route('courses.chapters', ['course' => $course->id]) }}">Lanjut Belajar</a>
                    @else
                        <a class="btn btn-primary col-12" href="{{ route('courses.enroll', ['course' => $course->id]) }}">Daftar ke Modul Ini</a>
                    @endif
                </div>
            </div>
        </div>
